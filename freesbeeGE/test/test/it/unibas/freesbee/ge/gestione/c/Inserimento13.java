...
public class Inserimento13 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testInserimento13() throws Exception {
        try {

            logger.info("TEST - 13");
            logger.info("Sottoscrittore esistente - Categoria eventi esterna esistente confermata attiva - Filtro Data corretto - Filtro Contenuto  uguale a ''");
            ...
            sms += "<filtroContenuto><regularExpression/></filtroContenuto>";
    ...
    public void testInserimento13Verifica() throws Exception {
        try {
            logger.info("TEST - 13");
