...
public class Inserimento9 extends ContextTestSupport {
    ...
    public void testInserimento9() throws Exception {
        try {
            ...
            logger.info("TEST - 9");
            logger.info("Sottoscrittore esistente - Categoria eventi interna esistente attiva - Filtro Data corretto - Tipo Sottoscrizione Notifica piccolo");
    ...
    public void testInserimento9Verifica() throws Exception {
        try {
            logger.info("TEST - 9");
