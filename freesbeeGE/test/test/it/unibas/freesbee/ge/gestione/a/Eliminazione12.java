...
public class Eliminazione12 extends ContextTestSupport {
    ...
    public void testEliminazione12Verifica() throws Exception {
        try {
            logger.info("TEST - 12");
            ...
            assertNotNull(pubblicatoreInterno);
            DAOPubblicatoreInternoFacade.verificaNonEsistenzaPubblicatoreInterno(categoriaEventiInterna, pubblicatoreInterno);
