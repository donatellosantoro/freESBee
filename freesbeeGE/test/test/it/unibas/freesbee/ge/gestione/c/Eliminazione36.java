...
public class Eliminazione36 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testEliminazione36() throws Exception {
        try {
            logger.info("TEST - 36");
            logger.info("Sottoscrittore esistente - Categoria eventi esterna esistente confermata attiva - Filtro Pubblicatore pubblicatore non confermato per nessuna categoria e unico ");
    ...
    public void testEliminazione36Verifica() throws Exception {
        try {
            logger.info("TEST - 36");
            logger.info("Verifica eliminazione sottoscrizione");

            DAOUtilHibernate.beginTransaction();
            DAOCategoriaEventiEsternaFacade.verificaEsistenzaCategoriaEventiEsternaAttavia(DAOMock.CATEGORIA_EVENTI_ESTERNA_CONFERMATA_ATTIVA_9);
