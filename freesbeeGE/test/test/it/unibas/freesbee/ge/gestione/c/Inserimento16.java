...
public class Inserimento16 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testInserimento16() throws Exception {
        try {
            logger.info("TEST - 16");
            logger.info("Sottoscrittore esistente - Categoria eventi esterna esistente confermata attiva - Filtro Pubblicatore già confermato");
            ...
            pubblicatore.setNome(DAOMock.NOME_SOGGETTO_P);
            pubblicatore.setDescrizione("");

            CategoriaEventiEsterna categoiraEventiEsterna = daoCategoriaEventiEsterna.findByNome(DAOMock.CATEGORIA_EVENTI_ESTERNA_CONFERMATA_ATTIVA_9);
    ...
    public void testInserimento16Verifica() throws Exception {
        try {
            logger.info("TEST - 16");
