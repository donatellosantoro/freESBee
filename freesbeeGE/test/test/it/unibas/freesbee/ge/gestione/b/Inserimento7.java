...
public class Inserimento7 extends ContextTestSupport {
    ...
    public void testInserimento7() throws Exception {
        try {
            ...
            logger.info("TEST - 7");
            logger.info("Sottoscrittore non esistente - Categoria eventi interna esistente attiva " + CategoriaEventiInterna.GE_CONTROL_PROTOCOL + " - Filtro Pubblicatori errato");
