...
public class Inserimento8 extends ContextTestSupport {
    ...
    public void testInserimento8() throws Exception {
        try {
            logger.info("TEST - 8");
            logger.info("Sottoscrittore non esistente - Categoria eventi esterna esistente confermata attiva - Filtro Data corretto - Tipo Sottoscrizione errato");
            ...
            sms += "<tipoSottoscrizione>" + DAOMock.TIPO_SOTTOSCRIZIONE_ERRATO + "</tipoSottoscrizione>";
