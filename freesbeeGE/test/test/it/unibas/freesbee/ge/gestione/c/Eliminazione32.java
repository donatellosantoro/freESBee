...
public class Eliminazione32 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testEliminazione32() throws Exception {
        try {
            logger.info("TEST - 32");
            logger.info("Sottoscrittore  esistente - Categoria eventi esterna esistente confermata attiva - Soggetto non sottoscrittore per la Categoria eventi");
