...
public class Inserimento15 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testInserimento15() throws Exception {
        try {
            logger.info("TEST - 15");
            logger.info("Sottoscrittore esistente - Categoria eventi esterna esistente confermata attiva -  Filtro Pubblicatore unsoggetto non esistente un soggetto pubblicatore interno");
