...
public class Inserimento22 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testInserimento22() throws Exception {
        try {

            logger.info("TEST - 22");
            logger.info("Sottoscrittore non esistente - Categoria eventi esterna esistente non confermata attiva - Filtro Data corretto - Tipo Sottoscrizione Consegna");
    ...
    public void testInserimento22Verifica() throws Exception {
        try {
            logger.info("TEST - 22");
