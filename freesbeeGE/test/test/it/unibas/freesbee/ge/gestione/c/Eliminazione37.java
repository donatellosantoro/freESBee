...
public class Eliminazione37 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testEliminazione37() throws Exception {
        try {
            logger.info("TEST - 37");
            logger.info("Sottoscrittore esistente - Categoria eventi esterna esistente confermata attiva - Filtro Pubblicatore pubblicatore confermato ");
    ...
    public void testEliminazione37Verifica() throws Exception {
        try {
            logger.info("TEST - 37");
            logger.info("Verifica eliminazione sottoscrizione");

            DAOUtilHibernate.beginTransaction();
            CategoriaEventiEsterna categoriaEventiEsterna = DAOCategoriaEventiEsternaFacade.verificaEsistenzaCategoriaEventiEsternaAttavia(DAOMock.CATEGORIA_EVENTI_ESTERNA_CONFERMATA_ATTIVA_9);
            ...
            assertFalse(DAOPubblicatoreEsternoFacade.isPubblicatoreEsternoPerCategoriaEventiEsterna(categoriaEventiEsterna, pubblicatore));
