...
public class Inserimento2 extends ContextTestSupport {
    ...
    public void testInserimento2() throws Exception {
        try {
            logger.info("TEST - 2");
            logger.info("Sottoscrittore non esistente - Categoria eventi interna esistente attiva - Filtro Data specificato ma senza Data Inizio");
            ...
            sms += "<filtroData><dataFine/><dataInizio/></filtroData>";
