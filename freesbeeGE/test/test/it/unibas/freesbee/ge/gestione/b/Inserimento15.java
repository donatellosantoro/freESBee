...
public class Inserimento15 extends ContextTestSupport {
    ...
    public void testInserimento15() throws Exception {
        try {
            ...
            logger.info("TEST - 15");
            logger.info("Sottoscrittore non esistente - Categoria Eventi Interna esistente attiva - Filtro Data corretto - Filtro Pubblicaotre corretto - Filtro Pubblicatore soggetto non esistente");
            ...
            sms += "<pubblicatore><descrizione/><nome>" + DAOMock.NOME_SOGGETTO_C + "</nome><tipo>" + DAOMock.TIPO_SOGGETTO_SPC + "</tipo></pubblicatore></listaFiltroPublicatore>";
