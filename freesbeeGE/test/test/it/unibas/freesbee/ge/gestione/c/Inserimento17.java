...
public class Inserimento17 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testInserimento17() throws Exception {
        try {
            logger.info("TEST - 17");
            logger.info("Sottoscrittore non esistente - Categoria eventi esterna esistente confermata attiva - Filtro Pubblicatore soggetto non esistente");
    ...
    public void testInserimento17Verifica() throws Exception {
        try {
            logger.info("TEST - 17");
