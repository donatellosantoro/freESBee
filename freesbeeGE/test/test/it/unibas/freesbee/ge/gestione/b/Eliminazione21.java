...
public class Eliminazione21 extends ContextTestSupport {
    ...
    public void testEliminazione21() throws Exception {
        try {
            logger.info("TEST - 21");
            logger.info("Sottoscrittore non esistente - Categoria eventi interna esistente attiva");
            ...
            sms += "<sottoscrittore><descrizione/><nome>" + DAOMock.NOME_SOGGETTO_C + "</nome><tipo>" + DAOMock.TIPO_SOGGETTO_SPC + "</tipo></sottoscrittore>";
