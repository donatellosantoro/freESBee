...
public class Eliminazione8 extends ContextTestSupport {
    ...
    public void testEliminazione8() throws Exception {
        try {
            ...
            logger.info("TEST - 8");
            logger.info("Pubblicatore esistente - Categoria eventi interna esistente attiva ma il gestore eventi non è pubblicatore della propria categoria");
    ...
    public void testEliminazione8Inserimento() throws Exception {
        logger.info("TEST - 0");
