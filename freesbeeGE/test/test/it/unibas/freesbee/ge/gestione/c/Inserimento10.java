...
public class Inserimento10 extends ContextTestSupport {
    ...
    public void testInserimento10() throws Exception {
        try {
            ...
            logger.info("TEST - 10");
            logger.info("Sottoscrittore non esistente - Categoria eventi esterna esistente confermata attiva - Filtro Data corretto - Tipo Sottoscrizione Consegna");
    ...
    public void testInserimento10Verifica() throws Exception {
        try {
            logger.info("TEST - 10");
