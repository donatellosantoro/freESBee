...
public class Eliminazione31 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testEliminazione31() throws Exception {
        try {
            logger.info("TEST - 31");
            logger.info("Sottoscrittore non esistente - Categoria eventi esterna esistente confermata attiva");
            ...
            sms += "<sottoscrittore><descrizione/><nome>" + DAOMock.NOME_SOGGETTO_T + "</nome><tipo>" + DAOMock.TIPO_SOGGETTO_SPC + "</tipo></sottoscrittore>";
