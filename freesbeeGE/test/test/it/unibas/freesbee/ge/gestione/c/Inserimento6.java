...
public class Inserimento6 extends ContextTestSupport {
    ...
    public void testInserimento6() throws Exception {
        try {
            logger.info("TEST - 6");
            logger.info("Sottoscrittore non esistente - Categoria eventi esterna esistente confermata attiva - Filtro Data pecificato ma Data Inizio anteriore a Data Attuale");
