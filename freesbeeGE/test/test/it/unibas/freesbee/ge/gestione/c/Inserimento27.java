...
public class Inserimento27 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testInserimento27() throws Exception {
        try {
            logger.info("TEST - 27");
            ...
            pubblicatore.setNome(DAOMock.NOME_SOGGETTO_K);
            pubblicatore.setDescrizione("");

            CategoriaEventiEsterna categoiraEventiEsterna = daoCategoriaEventiEsterna.findByNome(DAOMock.CATEGORIA_EVENTI_ESTERNA_NON_CONFERMATA_ATTIVA_8);
            ...
            sms += "<sottoscrittore><descrizione/><nome>" + DAOMock.NOME_SOGGETTO_Z + "</nome><tipo>" + DAOMock.TIPO_SOGGETTO_SPC + "</tipo></sottoscrittore>";
    ...
    public void testInserimento27Verifica() throws Exception {
        try {
            logger.info("TEST - 27");
            ...
            CategoriaEventiEsterna catgoriaEventiEsterna1 = DAOCategoriaEventiEsternaFacade.verificaEsistenzaCategoriaEventiEsternaAttavia(DAOMock.CATEGORIA_EVENTI_ESTERNA_NON_CONFERMATA_ATTIVA_8);
            IDAOSottoscrittore daoSottoscrittore = new DAOSottoscrittoreHibernate();
            Sottoscrittore sottoscrittore = daoSottoscrittore.findByTipoNome(DAOMock.TIPO_SOGGETTO_SPC, DAOMock.NOME_SOGGETTO_Z);
            ...
            IDAOPubblicatoreEsterno daoPubblicatoreEsterno = new DAOPubblicatoreEsternoHibernate();
            PubblicatoreEsterno soggettoPubblicatore = daoPubblicatoreEsterno.findByTipoNome(DAOMock.TIPO_SOGGETTO_SPC, DAOMock.NOME_SOGGETTO_K);
            ...
            assertTrue(DAOPubblicatoreEsternoFacade.isPubblicatoreEsternoPerCategoriaEventiEsterna(catgoriaEventiEsterna1, soggettoPubblicatore));
