...
public class Inserimento23 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testInserimento23() throws Exception {
        try {

            logger.info("TEST - 23");
            logger.info("Sottoscrittore esistente - Categoria eventi esterna esistente non confermata attiva - Filtro Data corretto - Tipo Sottoscrizione Notifica piccolo");
    ...
    public void testInserimento23Verifica() throws Exception {
        try {
            logger.info("TEST - 23");
