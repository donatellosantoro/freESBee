...
public class Eliminazione15 extends ContextTestSupport {
    ...
    public void testEliminazione15Verifica() throws Exception {
        try {
            logger.info("TEST - 15");
            logger.info("Verifica eliminazione pubblicatore");

            DAOUtilHibernate.beginTransaction();
            DAOCategoriaEventiInternaFacade.verificaEsistenzaCategoriaEventiInternaAttavia(DAOMock.CATEGORIA_EVENTI_INTERNA_ATTIVA_2);
