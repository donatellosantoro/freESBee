...
public class Inserimento16 extends ContextTestSupport {
    ...
    public void testInserimento16() throws Exception {
        try {
            ...
            logger.info("TEST - 16");
            logger.info("Sottoscrittore non esistente - Categoria eventi interna esistente attiva - Filtro Data corretto - Filtro Pubblicatore corretto ripetuto due volte");
