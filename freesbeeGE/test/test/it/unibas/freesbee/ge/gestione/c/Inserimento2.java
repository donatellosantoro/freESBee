...
public class Inserimento2 extends ContextTestSupport {
    ...
    public void testInserimento2() throws Exception {
        try {
            logger.info("TEST - 2");
            logger.info("Sottoscrittore non esistente - Categoria eventi esterna esistente non confermata non attiva");
