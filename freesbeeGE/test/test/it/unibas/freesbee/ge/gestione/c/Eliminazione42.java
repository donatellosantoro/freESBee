...
public class Eliminazione42 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testEliminazione42() throws Exception {
        try {
            logger.info("TEST - 42");
    ...
    public void testEliminazione42Verifica() throws Exception {
        try {
            logger.info("TEST - 42");
