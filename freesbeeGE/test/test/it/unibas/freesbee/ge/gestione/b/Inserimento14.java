...
public class Inserimento14 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testInserimento14() throws Exception {
        try {

            logger.info("TEST - 14");
            logger.info("Sottoscrittore non esistente - Categoria Eventi Interna esistente attiva - Filtro Data corretto - Filtro Pubblicatore soggetto esistente ma non pubblicatore per la Categoria eventi");
