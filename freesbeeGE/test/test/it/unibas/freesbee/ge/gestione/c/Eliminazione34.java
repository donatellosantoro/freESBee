...
public class Eliminazione34 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testEliminazione34() throws Exception {
        try {
            logger.info("TEST - 34");
    ...
    public void testEliminazione34Verifica() throws Exception {
        try {
            logger.info("TEST - 34");
