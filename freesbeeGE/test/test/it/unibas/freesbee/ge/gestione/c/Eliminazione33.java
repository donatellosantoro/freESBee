...
public class Eliminazione33 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testEliminazione33() throws Exception {
        try {
            logger.info("TEST - 33");
            logger.info("Sottoscrittore esistente - Categoria eventi esterna esistente confermata attiva - Nessun Filtro pubblicatore");
    ...
    public void testEliminazione33Verifica() throws Exception {
        try {
            logger.info("TEST - 33");
