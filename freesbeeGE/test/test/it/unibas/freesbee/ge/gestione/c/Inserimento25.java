...
public class Inserimento25 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testInserimento25() throws Exception {
        try {
            logger.info("TEST - 25");
            logger.info("Sottoscrittore non esistente - Categoria eventi esterna esistente non confermata attiva - Filtro Pubblicatore soggetto non esistente");
            ...
            sms += "<listaFiltroPublicatore><pubblicatore><descrizione/><nome>" + DAOMock.NOME_SOGGETTO_Y + "</nome><tipo>" + DAOMock.TIPO_SOGGETTO_SPC + "</tipo></pubblicatore></listaFiltroPublicatore>";
    ...
    public void testInserimento25Verifica() throws Exception {
        try {
            logger.info("TEST - 25");
            ...
            PubblicatoreEsterno soggettoPubblicatore = daoPubblicatoreEsterno.findByTipoNome(DAOMock.TIPO_SOGGETTO_SPC, DAOMock.NOME_SOGGETTO_Y);
