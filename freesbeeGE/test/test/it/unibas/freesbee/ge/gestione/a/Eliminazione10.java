...
public class Eliminazione10 extends ContextTestSupport {
    ...
    public void testEliminazione10() throws Exception {
        try {
            ...
            sms += "<pubblicatore><descrizione/><nome>" + DAOMock.NOME_SOGGETTO_C + "</nome><tipo>" + DAOMock.TIPO_SOGGETTO_SPC + "</tipo></pubblicatore>";
