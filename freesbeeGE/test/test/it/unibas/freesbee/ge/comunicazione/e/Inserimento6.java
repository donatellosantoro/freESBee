...
public class Inserimento6 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testInserimento6Init() throws Exception {
        logger.info("TEST - 6");
        logger.info("Init");
    ...
    public void testInserimento6() throws Exception {
        try {
            logger.info("TEST - 6");
            logger.info("Sottoscrittore non esistente - Categoria eventi esterna esistente non confermata attiva - Filtro Pubblicatore soggetto pubblicatore non confermato per nessuna categoria eventi");
            ...
            sms += "<listaFiltroPublicatore><pubblicatore><descrizione/><nome>" + DAOMock.NOME_SOGGETTO_O + "</nome><tipo>" + DAOMock.TIPO_SOGGETTO_SPC + "</tipo></pubblicatore></listaFiltroPublicatore>";
    ...
    public void testInserimento6Dopo() throws Exception {
        try {
            logger.info("TEST - 6");
            ...
            PubblicatoreEsterno soggettoPubblicatore = daoPubblicatoreEsterno.findByTipoNome(DAOMock.TIPO_SOGGETTO_SPC, DAOMock.NOME_SOGGETTO_O);
    ...
    public void testInserimento6VerificaComunicazioneEsterna() throws Exception {
        try {
            logger.info("TEST - 6");
            ...
            URL url = this.getClass().getResource("/dati/e/test6Esterno.xml");
