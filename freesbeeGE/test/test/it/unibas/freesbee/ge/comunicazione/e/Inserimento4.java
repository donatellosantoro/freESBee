...
public class Inserimento4 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testInserimento4Init() throws Exception {
        logger.info("TEST - 4");
        logger.info("Init");
    ...
    public void testInserimento4() throws Exception {
        try {
            logger.info("TEST - 4");
            logger.info("Sottoscrittore non esistente - Categoria eventi esterna esistente confermata attiva - Filtro Pubblicatore Soggeto  pubblicatore confermato per altre categorie eventi ma non confermato per la categoria eventi");
    ...
    public void testInserimento4Verifica() throws Exception {
        try {
            logger.info("TEST - 4");
    ...
    public void testInserimento4VerificaComunicazioneEsterna() throws Exception {
        try {
            logger.info("TEST - 4");
            ...
            URL url = this.getClass().getResource("/dati/e/test4Esterno.xml");
