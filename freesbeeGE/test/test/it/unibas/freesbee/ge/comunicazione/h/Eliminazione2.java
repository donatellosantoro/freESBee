...
public class Eliminazione2 extends ContextTestSupport {
    ...
    public void testEliminazione2Pubblicazione() throws Exception {
        logger.info("TEST - 2");
    ...
    public void testEliminazione2Dopo() throws Exception {
        try {
            ...
            CategoriaEventiEsterna categoria = daoCategoriaEventiEsterna.findByNome(DAOMock.CATEGORIA_EVENTI_ESTERNA_NON_CONFERMATA_ATTIVA_6);
    ...
    public void testInserimento2VerificaComunicazioneEsterna1() throws Exception {
        try {
            logger.info("TEST - 2");
