...
public class Eliminazione24 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());

    public void testEliminazione24Prima() throws Exception {
        try {
            logger.info("TEST - 24");
            ...
            pubblicatore = daoPubblicatoreEsterno.findByTipoNome(DAOMock.TIPO_SOGGETTO_SPC, DAOMock.NOME_SOGGETTO_P);
            assertNotNull(pubblicatore);
            DAOPubblicatoreEsternoFacade.verificaEsistenzaPubblicatoreEsterno(DAOMock.TIPO_SOGGETTO_SPC, DAOMock.NOME_SOGGETTO_P, DAOMock.CATEGORIA_EVENTI_ESTERNA_CONFERMATA_ATTIVA_9);
    ...
    public void testEliminazione24() throws Exception {
        logger.info("TEST - 24");
        logger.info("Pubblicatore non esistene - Categoria eventi esterna confermata attiva ");

        try {
            //Carico il messaggio che verebbe consegnato al GE
            URL url = this.getClass().getResource("/dati/d/test24.xml");
    ...
    public void testEliminazione24Dopo() throws Exception {
        try {
            logger.info("TEST - 24");
            logger.info("Verifica situazione pubblicatore");
