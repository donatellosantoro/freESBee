...
public class Richiesta13 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());

    public void testRichiesta13Prima() throws Exception {
        try {
            logger.info("TEST - 13");
            ...
            sottoscrittore = new Sottoscrittore(DAOMock.TIPO_SOGGETTO_SPC, DAOMock.NOME_SOGGETTO_NON_GE);
    ...
    public void testRichiesta13() throws Exception {
        logger.info("TEST - 13");
        logger.info("Categoria eventi esistente - Gestore Eventi pubblicatore sottoscrittore della catgoria");
    ...
    public void testRichiesta13Dopo() throws Exception {
        try {
            logger.info("TEST - 13");
            logger.info("Dopo");
