...
public class Richiesta15 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());

    public void testRichiesta15Prima() throws Exception {
        try {
            logger.info("TEST - 15");
            ...
            CategoriaEventiInterna categoriaEventi = daoCategoriaEventiInterna.findByNome(DAOMock.CATEGORIA_EVENTI_INTERNA_NON_ATTIVA_1);
    ...
    public void testRichiesta15() throws Exception {
        logger.info("TEST - 15");
        logger.info("Categoria eventi esistente - Gestore Eventi pubblicatore non sottoscrittore epr nessuna catgoria");

        try {
            //Carico il messaggio che verebbe consegnato al GE
            URL url = this.getClass().getResource("/dati/h/test15.xml");
    ...
    public void testRichiesta15Dopo() throws Exception {
        try {
            logger.info("TEST - 15");
            logger.info("Dopo");
