...
public class Richiesta9 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());

    public void testRichiesta9Prima() throws Exception {
        try {
            logger.info("TEST - 9");
