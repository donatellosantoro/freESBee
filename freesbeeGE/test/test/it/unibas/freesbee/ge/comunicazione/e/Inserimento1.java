...
public class Inserimento1 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testInserimento1Init() throws Exception {
        logger.info("TEST - 1");
        logger.info("Init");
        ...
        pubblicatore.setNome(DAOMock.NOME_SOGGETTO_T);
        pubblicatore.setDescrizione("");

        CategoriaEventiEsterna categoiraEventiEsterna = DAOCategoriaEventiEsternaFacade.verificaEsistenzaCategoriaEventiEsternaAttavia(DAOMock.CATEGORIA_EVENTI_ESTERNA_CONFERMATA_ATTIVA_7);
        DAOPubblicatoreEsternoFacade.aggiungiPubblicatoreEsterno(categoiraEventiEsterna, pubblicatore);
        assertFalse(DAOPubblicatoreEsternoFacade.isInAttesaPubblicatoreEsternoPerCategoriaEventi(categoiraEventiEsterna, pubblicatore));
        DAOUtilHibernate.commit();

    }

    public void testInserimento1() throws Exception {
        try {
            logger.info("TEST - 1");
    ...
    public void testInserimento1Verifica() throws Exception {
        try {
            logger.info("TEST - 1");
    ...
    public void testInserimento1VerificaComunicazioneEsterna() throws Exception {
        try {
            logger.info("TEST - 1");
