...
public class Conferma17 extends ContextTestSupport {
    ...
    public void test17Prima() throws Exception {
        logger.info("TEST - 17");
        logger.info("Prima");
        ...
        assertTrue(DAOGestoreEventiFacade.isEsistenzaGestoreEventi(DAOMock.TIPO_SOGGETTO_SPC, DAOMock.NOME_SOGGETTO_NON_GE));
    ...
    public void testConferma17() throws Exception {
        logger.info("TEST - 17");
        logger.info("Ricezione Conferma Pubblicatori per Categoria Eventi gia' confermata ma da altro gestore eventi");
        try {
            //Carico il messaggio che verebbe generato dal GE
            URL url = this.getClass().getResource("/dati/g/test16_17_18.xml");
    ...
    public void test17Dopo() throws Exception {
        logger.info("TEST - 17");
        logger.info("Dopo");
        DAOUtilHibernate.beginTransaction();
        IDAOCategoriaEventiEsterna daoCategoriaEventi = new DAOCategoriaEventiEsternaHibernate();
        ...
        daoGestoreEventi.makeTransient(gestoreEventi);
