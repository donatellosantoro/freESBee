...
public class Eliminazione27 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());

    public void testEliminazione27Init() throws Exception {
        logger.info("TEST - 27");
        logger.info("Init");
        ...
        CategoriaEventiEsterna categoriaEventi = daoCategoriaEventiEsterna.findByNome(DAOMock.CATEGORIA_EVENTI_ESTERNA_CONFERMATA_ATTIVA_9);
    ...
    public void testEliminazione27() throws Exception {
        logger.info("TEST - 27");
        ...
        try {
            ...
            URL url = this.getClass().getResource("/dati/d/test27.xml");
    ...
    public void testEliminazione27Dopo() throws Exception {
        try {
            logger.info("TEST - 27");
    ...
    public void testEliminazione27VerificaComunicazioneInterna() throws Exception {
        try {
            logger.info("TEST - 27");
            ...
            URL url = this.getClass().getResource("/dati/d/test27Interno.xml");
    ...
    public void testEliminazione27Clean() throws Exception {
        try {
            logger.info("TEST - 27");
            logger.info("Clean");
            ...
            DAOSottoscrizioneEsternaFacade.eliminaSottoscrizioneEsterna(daoCategoriaEventiEsterna.findByNome(DAOMock.CATEGORIA_EVENTI_ESTERNA_CONFERMATA_ATTIVA_9), sottoscrittoreL);
