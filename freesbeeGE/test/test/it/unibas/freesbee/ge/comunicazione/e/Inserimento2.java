...
public class Inserimento2 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testInserimento2Init() throws Exception {
        logger.info("TEST - 2");
        logger.info("Init");
    ...
    public void testInserimento2() throws Exception {
        try {
            logger.info("TEST - 2");
            logger.info("Sottoscrittore esistente - Categoria eventi esterna esistente confermata attiva - Filtro Pubblicatore soggetto non esistente");
    ...
    public void testInserimento2Dopo() throws Exception {
        try {
            logger.info("TEST - 2");
    ...
    public void testInserimento2VerificaComunicazioneEsterna() throws Exception {
        try {
            logger.info("TEST - 2");
            ...
            URL url = this.getClass().getResource("/dati/e/test2Esterno.xml");
