...
public class Conferma22 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testConferma22Prima() throws Exception {
        try {
            logger.info("TEST - 22");
            logger.info("Prima");
    ...
    public void testConferma22VerificaPrima() throws Exception {
        try {
            logger.info("TEST - 22");
            ...
            CategoriaEventiEsterna catgoriaEventiEsterna = DAOCategoriaEventiEsternaFacade.verificaEsistenzaCategoriaEventiEsternaAttavia(DAOMock.CATEGORIA_EVENTI_ESTERNA_NON_CONFERMATA_ATTIVA_34);
            ...
            soggettoPubblicatore = daoPubblicatoreEsterno.findByTipoNome(DAOMock.TIPO_SOGGETTO_SPC, DAOMock.NOME_SOGGETTO_S);
    ...
    public void testConferma22() throws Exception {
        logger.info("TEST - 22");
        logger.info("Si è Ricevuta Confemra Pubblicatori per la cateogria di eventi non confermata con un pubblicatore non presente nel database");
        try {
            //Carico il messaggio che verebbe generato dal GE
            URL url = this.getClass().getResource("/dati/g/test22.xml");
    ...
    public void testConferma22VerificaDopo() throws Exception {
        try {
            logger.info("TEST - 22");
