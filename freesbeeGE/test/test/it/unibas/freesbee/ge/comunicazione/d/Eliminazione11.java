...
public class Eliminazione11 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());

    public void testEliminazione11Prima() throws Exception {
        try {
            logger.info("TEST - 11");
    ...
    public void testEliminazione11() throws Exception {
        logger.info("TEST - 11");
        logger.info("Pubblicatore non esistene - Categoria eventi esterna non confermata non attiva ");

        try {
            //Carico il messaggio che verebbe consegnato al GE
            URL url = this.getClass().getResource("/dati/d/test11.xml");
    ...
    public void testEliminazione11Dopo() throws Exception {
        try {
            logger.info("TEST - 11");
            logger.info("Verifica situazione pubblicatore");
