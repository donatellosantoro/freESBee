...
public class Conferma9 extends ContextTestSupport {
    ...
    public void testInserimento9Init() throws Exception {
        logger.info("TEST - 9");
        logger.info("Init");
    ...
    public void test9Prima() throws Exception {
        ...
        PubblicatoreInterno pubblicatore = daoPubblicatoreInterno.findByTipoNome(DAOMock.TIPO_SOGGETTO_SPC, DAOMock.NOME_SOGGETTO_P);
    ...
    public void testInserimento9VerificaComunicazioneEsterna() throws Exception {
        try {
            logger.info("TEST - 9");
