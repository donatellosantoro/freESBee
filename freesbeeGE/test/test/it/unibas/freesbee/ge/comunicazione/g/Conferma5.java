...
public class Conferma5 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());

    public void testConferma5() throws Exception {
        logger.info("TEST - 5");
        logger.info("Ricezione Richiesta Conferma Pubblicatori per Categoria Eventi interna e attiva ma senza elenco di pubblicatori da confermare");
        try {
            //Carico il messaggio che verebbe generato dal GE
            URL url = this.getClass().getResource("/dati/g/test5.xml");
