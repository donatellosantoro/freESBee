...
public class Eliminazione14 extends ContextTestSupport {
    ...
    public void testEliminazione14Init() throws Exception {
        logger.info("TEST - 14");
        logger.info("Init");
    ...
    public void testEliminazione14() throws Exception {
        ...
        try {
            ...
            URL url = this.getClass().getResource("/dati/d/test14.xml");
    ...
    public void testEliminazione14Dopo() throws Exception {
        try {
            logger.info("TEST - 14");
    ...
    public void testEliminazione14VerificaComunicazioneInterna() throws Exception {
        try {
            logger.info("TEST - 14");
            ...
            URL url = this.getClass().getResource("/dati/d/test14Interno.xml");
    ...
    public void testEliminazione14Clean() throws Exception {
        try {
            logger.info("TEST - 14");
            logger.info("Clean");
            ...
            DAOSottoscrizioneEsternaFacade.eliminaSottoscrizioneEsterna(daoCategoriaEventiEsterna.findByNome(DAOMock.CATEGORIA_EVENTI_ESTERNA_NON_CONFERMATA_ATTIVA_6), sottoscrittoreL);
