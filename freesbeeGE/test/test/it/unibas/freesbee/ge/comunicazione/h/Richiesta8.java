...
public class Richiesta8 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());

    public void testRichiesta8Prima() throws Exception {
        try {
            logger.info("TEST - 8");
            ...
            CategoriaEventiInterna categoriaEventi = daoCategoriaEventiInterna.findByNome(ICategoriaEventi.GE_CONTROL_PROTOCOL);
    ...
    public void testRichiesta8() throws Exception {
        logger.info("TEST - 8");
        logger.info("Categoria eventi GEControlProtocol - Gestore Eventi esistente");

        try {
            //Carico il messaggio che verebbe consegnato al GE
            URL url = this.getClass().getResource("/dati/h/test8.xml");
