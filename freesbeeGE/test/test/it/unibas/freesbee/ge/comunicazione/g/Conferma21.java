...
public class Conferma21 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testConferma21Prima() throws Exception {
        try {
            logger.info("TEST - 21");
            logger.info("Prima");
    ...
    public void testConferma21VerificaPrima() throws Exception {
        try {
            logger.info("TEST - 21");
            ...
            CategoriaEventiEsterna catgoriaEventiEsterna = DAOCategoriaEventiEsternaFacade.verificaEsistenzaCategoriaEventiEsternaAttavia(DAOMock.CATEGORIA_EVENTI_ESTERNA_NON_CONFERMATA_ATTIVA_33);
            ...
            PubblicatoreEsterno soggettoPubblicatore = daoPubblicatoreEsterno.findByTipoNome(DAOMock.TIPO_SOGGETTO_SPC, DAOMock.NOME_SOGGETTO_NON_GE);
    ...
    public void testConferma21() throws Exception {
        logger.info("TEST - 21");
        ...
        try {
            ...
            URL url = this.getClass().getResource("/dati/g/test21.xml");
    ...
    public void testConferma21VerificaDopo() throws Exception {
        try {
            logger.info("TEST - 21");
