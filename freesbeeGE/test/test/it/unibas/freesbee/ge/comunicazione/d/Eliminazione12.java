...
public class Eliminazione12 extends ContextTestSupport {
    ...
    public void testEliminazione12Prima() throws Exception {
        logger.info("TEST - 12");
    ...
    public void testEliminazione12() throws Exception {
        logger.info("TEST - 12");
        logger.info("Pubblicatore esistene non pubblicatore da confermare per la categoria - Categoria eventi esterna non confermata attiva");

        try {
            //Carico il messaggio che verebbe consegnato al GE
            URL url = this.getClass().getResource("/dati/d/test12.xml");
