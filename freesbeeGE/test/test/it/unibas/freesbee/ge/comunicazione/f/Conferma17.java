...
public class Conferma17 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testConferma17Prima() throws Exception {
        try {
            logger.info("TEST - 17");
            logger.info("Prima");
    ...
    public void testConferma17VerificaPrima() throws Exception {
        try {
            logger.info("TEST - 17");
    ...
    public void testConferma17VerificaDopo() throws Exception {
        try {
            logger.info("TEST - 17");
