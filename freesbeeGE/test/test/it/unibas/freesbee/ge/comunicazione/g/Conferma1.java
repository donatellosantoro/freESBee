...
public class Conferma1 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());

    public void testConferma1Init() throws Exception {
        logger.info("TEST - 1");
        logger.info("Init");
    ...
    public void testConferma1() throws Exception {
        logger.info("TEST - 1");
        logger.info("Ricezione Richiesta Conferma Pubblicatori");
        try {
            //Carico il messaggio che verebbe generato dal GE
            URL url = this.getClass().getResource("/dati/g/test1.xml");
            ...
            Assert.fail("La pubblicazione di richiesta di informazioni per i pubblicatori  ha lanciato eccezione");
        }
    }

    public void testConferma1VerificaConsegnaComunicazione() {
        try {
            logger.info("TEST - 1");
            ...
            URL url = this.getClass().getResource("/dati/g/test1Consegna.xml");
