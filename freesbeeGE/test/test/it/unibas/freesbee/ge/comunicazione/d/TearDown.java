...
public class TearDown extends ContextTestSupport {
    ...
    protected void tearDown() throws Exception {
        ...
        DAOMock.ripulisciSottoscrittoreSottoscrizioneIntera(DAOMock.TIPO_SOGGETTO_SPC, DAOMock.NOME_SOGGETTO_S, ICategoriaEventi.GE_CONTROL_PROTOCOL);

        logger.info("Ripulitura Pubblicatori Esterni Confermati");
        DAOMock.ripulisciPubblicatoreEsterno(DAOMock.TIPO_SOGGETTO_SPC, DAOMock.NOME_SOGGETTO_R, DAOMock.CATEGORIA_EVENTI_ESTERNA_CONFERMATA_ATTIVA_9);
