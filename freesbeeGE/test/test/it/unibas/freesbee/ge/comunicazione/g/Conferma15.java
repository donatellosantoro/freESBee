...
public class Conferma15 extends ContextTestSupport {
    ...
    public void test15Prima() throws Exception {
        logger.info("TEST - 15");
        logger.info("Prima");
        DAOUtilHibernate.beginTransaction();
        IDAOCategoriaEventiEsterna daoCategoriaEventi = new DAOCategoriaEventiEsternaHibernate();
        CategoriaEventiEsterna categoriaEventi = daoCategoriaEventi.findByNome(DAOMock.CATEGORIA_EVENTI_ESTERNA_CONFERMATA_NON_ATTIVA_5);
    ...
    public void testConferma15() throws Exception {
        ...
        try {
            ...
            URL url = this.getClass().getResource("/dati/g/test15.xml");
