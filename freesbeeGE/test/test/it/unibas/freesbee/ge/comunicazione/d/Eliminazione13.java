...
public class Eliminazione13 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());

    public void testEliminazione13Init() throws Exception {
        logger.info("TEST - 13");
        logger.info("Init");
    ...
    public void testEliminazione13() throws Exception {
        logger.info("TEST - 13");
        ...
        try {
            ...
            URL url = this.getClass().getResource("/dati/d/test13.xml");
    ...
    public void testEliminazione13Dopo() throws Exception {
        try {
            logger.info("TEST - 13");
            ...
            CategoriaEventiEsterna categoria = DAOCategoriaEventiEsternaFacade.verificaEsistenzaCategoriaEventiEsternaAttavia(DAOMock.CATEGORIA_EVENTI_ESTERNA_NON_CONFERMATA_ATTIVA_6);
    ...
    public void testEliminazione13VerificaComunicazioneInterna() throws Exception {
        try {
            logger.info("TEST - 13");
            ...
            URL url = this.getClass().getResource("/dati/d/test13Interno.xml");
      ...
      public void testEliminazione13VerificaComunicazioneInterna1() throws Exception {
        try {
            logger.info("TEST - 13");
            ...
            //Comunicazione di test
            URL url = this.getClass().getResource("/dati/d/test13Interno1.xml");
            doc = XmlJDomUtil.caricaXML(url.getFile(), false);
            String m = XmlJDomUtil.convertiDocumentToString(doc);
