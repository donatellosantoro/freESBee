...
public class Inserimento3 extends ContextTestSupport {
    ...
    public void testInserimento3() throws Exception {
        try {
            logger.info("TEST - 3");
            logger.info("Sottoscrittore non esistente - Categoria eventi esterna esistente confermata attiva - Filtro Pubblicatore soggetto pubblicatore non confermato per nessuna categoria eventi");
    ...
    public void testInserimento3Dopo() throws Exception {
        try {
            logger.info("TEST - 3");
    ...
    public void testInserimento3VerificaComunicazioneEsterna() throws Exception {
        try {
            ...
            URL url = this.getClass().getResource("/dati/e/test3Esterno.xml");
