...
public class Conferma20 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testConferma20Prima() throws Exception {
        try {
            logger.info("TEST - 20");
            logger.info("Prima");
    ...
    public void testConferma20VerificaPrima() throws Exception {
        try {
            logger.info("TEST - 20");
    ...
    public void testConferma20() throws Exception {
        logger.info("TEST - 20");
        logger.info("Si è Ricevuta Confemra Pubblicatori per la cateogria di eventi non confermata");
        try {
            //Carico il messaggio che verebbe generato dal GE
            URL url = this.getClass().getResource("/dati/g/test20.xml");
    ...
    public void testConferma20VerificaDopo() throws Exception {
        try {
            logger.info("TEST - 20");
