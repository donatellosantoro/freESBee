...
public class Conferma1 extends ContextTestSupport {
    ...
    public void testConferma1() throws Exception {
        ...
        try {
            ...
            URL url = this.getClass().getResource("/dati/f/test1.xml");
            ...
            Assert.fail("La pubblicazione di richiesta di informazioni per la categoria ha lanciato eccezione");
        }
    }
    ...
    public void testConferma1VerificaConsegnaComunicazione() {
        try {
            ...
            URL url = this.getClass().getResource("/dati/f/test1Consegna.xml");
