...
public class Pubblicazione11 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testPubblicazione11Init() throws Exception {
        logger.info("TEST - 11");
        logger.info("Init");
    ...
    public void testPubblicazione11Prima() throws Exception {
        try {
            logger.info("TEST - 11");
   ...
   DAOUtilHibernate.beginTransaction();
    ...
    public void testPubblicazione11() throws Exception {
        logger.info("TEST - 11");
    ...
    public void testPubblicazione11VerificaConsegnaComunicazione() {
        try {
            logger.info("TEST - 11");
    ...
    public void testPubblicazione11Clean() throws Exception {
        try {
            logger.info("TEST - 11");
            logger.info("Clean");
