...
public class Pubblicazione23 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;
    protected static String id;

    public void testPubblicazione23Init() throws Exception {
        logger.info("TEST - 23");
        logger.info("Init");
    ...
    public void testPubblicazione23Prima() throws Exception {
        try {
            logger.info("TEST - 23");
    ...
    public void testPubblicazione23() throws Exception {
        logger.info("TEST - 23");
    ...
    public void testPubblicazione23VerificaNotificaComunicazione() throws Exception {
        try {
            logger.info("TEST - 23");
...
//        s = "<SOAP-ENV:Envelope xmlns:SOAP-ENV=\"http://schemas.xmlsoap.org/soap/envelope/\"><SOAP-ENV:Header/><SOAP-ENV:Body><ns2:notificaEventoPubblicato xmlns:ns2=\"http://ge.freesbee.unibas.it/\"><idEventoPubblicato>32771</idEventoPubblicato></ns2:notificaEventoPubblicato></SOAP-ENV:Body></SOAP-ENV:Envelope>";
    ...
    public void testPubblicazione23PrelevaMessaggio() throws Exception {
        logger.info("TEST - 23");
        ...
        try {
            ...
            ConsegnaEventoPubblicato risposta = port.prelevaMessaggio(id, DAOMock.NOME_SOGGETTO_D, DAOMock.TIPO_SOGGETTO_SPC, DAOMock.CATEGORIA_EVENTI_INTERNA_ATTIVA_2);

            logger.info(risposta.getMessaggioSoap());

            URL url = this.getClass().getResource("/dati/i/test1ConsegnaNotifica.xml");
            Document doc = XmlJDomUtil.caricaXML(url.getFile(), false);
            String m = XmlJDomUtil.convertiDocumentToString(doc);
    ...
    public void testPubblicazione23Clean() throws Exception {
        try {
            logger.info("TEST - 23");
            logger.info("Clean");
            Thread.currentThread().sleep(15000);
