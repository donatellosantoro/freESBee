...
public class Pubblicazione22 extends ContextTestSupport {
    ...
    public void testPubblicazione22Init() throws Exception {
        ...
        DAOMock.inserisciPubblicatoreInterno(DAOMock.TIPO_SOGGETTO_SPC, DAOMock.NOME_SOGGETTO_GE, ICategoriaEventi.GE_CONTROL_PROTOCOL);
    ...
    public void testPubblicazione22() throws Exception {
        logger.info("TEST - 22");
        logger.info("Cateogria di Eventi GEControlProtocol Prubblicato da altro Gestore Eventi non NICA -> PubblicazioneEsterna");
        try {
            Thread.currentThread().sleep(15000);
            //Carico il messaggio che verebbe generato dal GE
            URL url = this.getClass().getResource("/dati/i/test8.xml");
    ...
    public void testPubblicazione22Clean() throws Exception {
        ...
        logger.info("Clean");
        DAOUtilHibernate.beginTransaction();
        DAOMock.ripulisciPubblicatoreInterno(DAOMock.TIPO_SOGGETTO_SPC, DAOMock.NOME_SOGGETTO_GE, ICategoriaEventi.GE_CONTROL_PROTOCOL);
        DAOUtilHibernate.commit();
    }
