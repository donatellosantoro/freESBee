...
public class Pubblicazione19 extends ContextTestSupport {
    ...
    public void testPubblicazione19Init() throws Exception {
        logger.info("TEST - 19");
        logger.info("Init");
    ...
    public void testPubblicazione19VerificaConsegnaComunicazione() {
        try {
            logger.info("TEST - 19");
    ...
    public void testPubblicazione19Clean() throws Exception {
        try {
            logger.info("TEST - 19");
            logger.info("Clean");
