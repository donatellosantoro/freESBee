...
public class Pubblicazione8 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testPubblicazione8Init() throws Exception {
        logger.info("TEST - 8");
        logger.info("Init");
    ...
    public void testPubblicazione8Prima() throws Exception {
        try {
            logger.info("TEST - 8");
    ...
    public void testPubblicazione8() throws Exception {
        logger.info("TEST - 8");
    ...
    public void testPubblicazione8VerificaConsegnaComunicazione() {
        try {
            logger.info("TEST - 8");
    ...
    public void testPubblicazione8Clean() throws Exception {
        try {
            logger.info("TEST - 8");
            logger.info("Clean");
