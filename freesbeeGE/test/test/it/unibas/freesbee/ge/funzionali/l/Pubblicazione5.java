...
public class Pubblicazione5 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testPubblicazione5Init() throws Exception {
        logger.info("TEST - 5");
        logger.info("Init");
    ...
    public void testPubblicazione5Prima() throws Exception {
        try {
            logger.info("TEST - 5");
            ...
            sms += "<filtroContenuto><regularExpression>xxx</regularExpression></filtroContenuto>";
    ...
    public void testPubblicazione5() throws Exception {
        logger.info("TEST - 5");
    ...
    public void testPubblicazione5VerificaConsegnaComunicazione() {
        try {
            logger.info("TEST - 5");
    ...
    public void testPubblicazione5Clean() throws Exception {
        try {
            logger.info("TEST - 5");
            logger.info("Clean");
