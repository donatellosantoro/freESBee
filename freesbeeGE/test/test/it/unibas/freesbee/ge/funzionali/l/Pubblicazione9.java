...
public class Pubblicazione9 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testPubblicazione9Init() throws Exception {
        logger.info("TEST - 9");
        logger.info("Init");
    ...
    public void testPubblicazione9Prima() throws Exception {
        try {
            logger.info("TEST - 9");
            ...
            PubblicatoreEsterno pubblicatore = daoPubblicatoreEsterno.findByTipoNome(DAOMock.TIPO_SOGGETTO_SPC, DAOMock.NOME_SOGGETTO_A);
            categoria.getListaPubblicatori().add(pubblicatore);
            pubblicatore.getListaCatgoriaEventi().add(categoria);
    ...
    public void testPubblicazione9() throws Exception {
        logger.info("TEST - 9");
    ...
    public void testPubblicazione9VerificaConsegnaComunicazione() {
        try {
            logger.info("TEST - 9");
    ...
    public void testPubblicazione9Clean() throws Exception {
        try {
            logger.info("TEST - 9");
            logger.info("Clean");
