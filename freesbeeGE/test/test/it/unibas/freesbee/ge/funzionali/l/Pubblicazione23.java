...
public class Pubblicazione23 extends ContextTestSupport {
    ...
    public void testPubblicazione23Prima() throws Exception {
        try {
            ...
            sms += "<listaFiltroPublicatore><pubblicatore><descrizione/><nome>" + DAOMock.NOME_SOGGETTO_F + "</nome><tipo>" + DAOMock.TIPO_SOGGETTO_SPC + "</tipo></pubblicatore></listaFiltroPublicatore>";
    ...
    public void testPubblicazione23() throws Exception {
        logger.info("TEST - 23");
        logger.info("Pubblicazione di GE (F) per la categoria Test7 - Sottoscrizione non confermata");
        try {
            Thread.currentThread().sleep(15000);
            //Carico il messaggio che verebbe generato dal GE
            URL url = this.getClass().getResource("/dati/l/test13.xml");
    ...
    public void testPubblicazione23VerificaConsegnaComunicazione() {
        try {
            logger.info("TEST - 23");
