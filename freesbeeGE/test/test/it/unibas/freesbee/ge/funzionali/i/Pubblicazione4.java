...
public class Pubblicazione4 extends ContextTestSupport {
    ...
    public void testPubblicazione4Init() throws Exception {
        logger.info("TEST - 4");
        logger.info("Init");
    ...
    public void testPubblicazione4Prima() throws Exception {
        try {
            logger.info("TEST - 4");
            logger.info("Data di inizio anteriore e data di fine posteriore a quella di pubblicazione");
    ...
    public void testPubblicazione4VerificaConsegnaComunicazione() {
        try {
            logger.info("TEST - 4");
    ...
    public void testPubblicazione4Clean() throws Exception {
        try {
            logger.info("TEST - 4");
            logger.info("Clean");
