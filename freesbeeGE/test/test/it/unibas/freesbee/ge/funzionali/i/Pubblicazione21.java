...
public class Pubblicazione21 extends ContextTestSupport {
    ...
    public void testPubblicazione21Init() throws Exception {
        logger.info("TEST - 21");
        logger.info("Init");
    ...
    public void testPubblicazione21Prima() throws Exception {
        try {
            logger.info("TEST - 21");
    ...
    public void testPubblicazione21Clean() throws Exception {
        logger.info("TEST - 21");
        logger.info("Clean");
        DAOUtilHibernate.beginTransaction();
    ...
    public void testPubblicazione21CleanDopo() throws Exception {
        try {
            logger.info("TEST - 21");
