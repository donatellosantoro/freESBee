...
public class Prelievo27 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;
    protected static String id;

    public void testPrelievo27Init() throws Exception {
        logger.info("TEST - 27");
        logger.info("Init");
        ...
        Sottoscrittore sottoscrittore = new Sottoscrittore(DAOMock.TIPO_SOGGETTO_SPC, DAOMock.NOME_SOGGETTO_C);
        daoSottoscrittore.makePersistent(sottoscrittore);
        DAOUtilHibernate.commit();
    }

    public void testPrelievo27Prima() throws Exception {
        try {
            logger.info("TEST - 27");
    ...
    public void testPrelievo27() throws Exception {
        logger.info("TEST - 27");
    ...
    public void testPrelievo27VerificaNotificaComunicazione() throws Exception {
        try {
            logger.info("TEST - 27");
...
//        s = "<SOAP-ENV:Envelope xmlns:SOAP-ENV=\"http://schemas.xmlsoap.org/soap/envelope/\"><SOAP-ENV:Header/><SOAP-ENV:Body><ns2:notificaEventoPubblicato xmlns:ns2=\"http://ge.freesbee.unibas.it/\"><idEventoPubblicato>32771</idEventoPubblicato></ns2:notificaEventoPubblicato></SOAP-ENV:Body></SOAP-ENV:Envelope>";
    ...
    public void testPrelievo27PrelevaMessaggio() throws Exception {
        logger.info("TEST - 27");
        ...
        try {
            ...
            ConsegnaEventoPubblicato risposta = port.prelevaMessaggio(id, DAOMock.NOME_SOGGETTO_C, DAOMock.TIPO_SOGGETTO_SPC, DAOMock.CATEGORIA_EVENTI_ESTERNA_CONFERMATA_ATTIVA_7);
    ...
    public void testPrelievo27Clean() throws Exception {
        try {
            logger.info("TEST - 27");
            logger.info("Clean");
            Thread.currentThread().sleep(15000);
            ...
            DAOUtilHibernate.beginTransaction();
            IDAOSottoscrittore daoSottoscrittore = new DAOSottoscrittoreHibernate();
            Sottoscrittore sottoscrittore = daoSottoscrittore.findByTipoNome(DAOMock.TIPO_SOGGETTO_SPC, DAOMock.NOME_SOGGETTO_C);
