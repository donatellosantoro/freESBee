...
public class TestSuite9GestoreEventi extends TestCase {

    protected static Log logger = LogFactory.getLog(TestSuite9GestoreEventi.class);
    ...
    public static TestSuite suite() {
        ...
        suite.addTestSuite(Prelievo25.class);
