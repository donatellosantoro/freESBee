...
public class Pubblicazione18 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testPubblicazione18Init() throws Exception {
        logger.info("TEST - 18");
        logger.info("Init");
 ...
 Thread.currentThread().sleep(5000);
    ...
    public void testPubblicazione18Prima() throws Exception {
        try {
            logger.info("TEST - 18");
    ...
    public void testPubblicazione18() throws Exception {
        logger.info("TEST - 18");
        logger.info("Pubblicazione di GE (C) per la categoria Test7");
        try {
            Thread.currentThread().sleep(15000);
            //Carico il messaggio che verebbe generato dal GE
            URL url = this.getClass().getResource("/dati/l/test9.xml");
    ...
    public void testPubblicazione18VerificaConsegnaComunicazione() {
        try {
            logger.info("TEST - 18");
            ...
            URL url = this.getClass().getResource("/dati/l/test9Consegna.xml");
    ...
    public void testPubblicazione18Clean() throws Exception {
        try {
            logger.info("TEST - 18");
            logger.info("Clean");
