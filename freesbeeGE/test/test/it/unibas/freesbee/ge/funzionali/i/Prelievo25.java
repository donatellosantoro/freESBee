...
public class Prelievo25 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;
    protected static String id;

    public void testPrelievo25Init() throws Exception {
        logger.info("TEST - 25");
        logger.info("Init");
    ...
    public void testPrelievo25Prima() throws Exception {
        try {
            logger.info("TEST - 25");
    ...
    public void testPrelievo25() throws Exception {
        logger.info("TEST - 25");
    ...
    public void testPrelievo25VerificaNotificaComunicazione() throws Exception {
        try {
            logger.info("TEST - 25");
...
//        s = "<SOAP-ENV:Envelope xmlns:SOAP-ENV=\"http://schemas.xmlsoap.org/soap/envelope/\"><SOAP-ENV:Header/><SOAP-ENV:Body><ns2:notificaEventoPubblicato xmlns:ns2=\"http://ge.freesbee.unibas.it/\"><idEventoPubblicato>32771</idEventoPubblicato></ns2:notificaEventoPubblicato></SOAP-ENV:Body></SOAP-ENV:Envelope>";
    ...
    public void testPrelievo25PrelevaMessaggio() throws Exception {
        logger.info("TEST - 25");
    ...
    public void testPrelievo25Clean() throws Exception {
        try {
            logger.info("TEST - 25");
            logger.info("Clean");
            Thread.currentThread().sleep(15000);
