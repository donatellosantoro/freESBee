...
public class Pubblicazione6 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testPubblicazione6Init() throws Exception {
        logger.info("TEST - 6");
        logger.info("Init");
    ...
    public void testPubblicazione6Prima() throws Exception {
        try {
            logger.info("TEST - 6");
            logger.info("Filtro contenuto errato");
            ...
            sms += "<filtroContenuto><regularExpression>Pisticci</regularExpression></filtroContenuto>";
    ...
    public void testPubblicazione6() throws Exception {
        logger.info("TEST - 6");
    ...
    public void testPubblicazione6VerificaConsegnaComunicazione() {
        try {
            logger.info("TEST - 6");
    ...
    public void testPubblicazione6Clean() throws Exception {
        try {
            logger.info("TEST - 6");
            logger.info("Clean");
