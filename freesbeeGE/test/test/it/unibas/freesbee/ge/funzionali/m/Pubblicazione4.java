...
public class Pubblicazione4 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;

    public void testPubblicazione4Prima() throws Exception {
        try {
            logger.info("TEST - 4");
            logger.info("Prima");
    ...
    public void testPubblicazione4Disattiva() throws Exception {
        logger.info("TEST - 4");
        logger.info("Dopo");
    ...
    public void testPubblicazione4() throws Exception {
        logger.info("TEST - 4");
    ...
    public void testPubblicazione4Dopo() throws Exception {
        logger.info("TEST - 4");
        logger.info("Dopo");
        DAOUtilHibernate.beginTransaction();
        IDAOCategoriaEventiEsterna daoCategoriaEventiEsterna = new DAOCategoriaEventiEsternaHibernate();
        CategoriaEventiEsterna categoriaEventiEsterna = daoCategoriaEventiEsterna.findByNome(DAOMock.CATEGORIA_EVENTI_ESTERNA_CONFERMATA_ATTIVA_9);
        assertFalse(categoriaEventiEsterna.isAttiva());
        IDAOEventoPubblicatoEsterno daoEventoPubblicatoEsterno = new DAOEventoPubblicatoEsternoHibernate();
        List<EventoPubblicatoEsterno> lista = daoEventoPubblicatoEsterno.findAll();
