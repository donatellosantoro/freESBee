...
public class Prelievo26 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;
    protected static String id;

    public void testPrelievo26Init() throws Exception {
        logger.info("TEST - 26");
        logger.info("Init");
    ...
    public void testPrelievo26Prima() throws Exception {
        try {
            logger.info("TEST - 26");
    ...
    public void testPrelievo26() throws Exception {
        logger.info("TEST - 26");
    ...
    public void testPrelievo26VerificaNotificaComunicazione() throws Exception {
        try {
            logger.info("TEST - 26");
...
//        s = "<SOAP-ENV:Envelope xmlns:SOAP-ENV=\"http://schemas.xmlsoap.org/soap/envelope/\"><SOAP-ENV:Header/><SOAP-ENV:Body><ns2:notificaEventoPubblicato xmlns:ns2=\"http://ge.freesbee.unibas.it/\"><idEventoPubblicato>32771</idEventoPubblicato></ns2:notificaEventoPubblicato></SOAP-ENV:Body></SOAP-ENV:Envelope>";
    ...
    public void testPrelievo26PrelevaMessaggio() throws Exception {
        logger.info("TEST - 26");
        ...
        try {
            ...
            ConsegnaEventoPubblicato risposta = port.prelevaMessaggio(id, DAOMock.NOME_SOGGETTO_C, DAOMock.TIPO_SOGGETTO_SPC, DAOMock.CATEGORIA_EVENTI_INTERNA_ATTIVA_2);
    ...
    public void testPrelievo26Clean() throws Exception {
        try {
            logger.info("TEST - 26");
            logger.info("Clean");
            Thread.currentThread().sleep(15000);
