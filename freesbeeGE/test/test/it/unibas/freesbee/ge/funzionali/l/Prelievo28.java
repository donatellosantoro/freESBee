...
public class Prelievo28 extends ContextTestSupport {

    protected Log logger = LogFactory.getLog(this.getClass());
    protected MockEndpoint resultEndpoint;
    protected static String id;

    public void testPrelievo28Init() throws Exception {
        logger.info("TEST - 28");
        logger.info("Init");
    ...
    public void testPrelievo28Prima() throws Exception {
        try {
            logger.info("TEST - 28");
    ...
    public void testPrelievo28() throws Exception {
        logger.info("TEST - 28");
    ...
    public void testPrelievo28VerificaNotificaComunicazione() throws Exception {
        try {
            logger.info("TEST - 28");
...
//        s = "<SOAP-ENV:Envelope xmlns:SOAP-ENV=\"http://schemas.xmlsoap.org/soap/envelope/\"><SOAP-ENV:Header/><SOAP-ENV:Body><ns2:notificaEventoPubblicato xmlns:ns2=\"http://ge.freesbee.unibas.it/\"><idEventoPubblicato>32871</idEventoPubblicato></ns2:notificaEventoPubblicato></SOAP-ENV:Body></SOAP-ENV:Envelope>";
    ...
    public void testPrelievo28PrelevaMessaggio() throws Exception {
        logger.info("TEST - 28");
        ...
        try {
            ...
            ConsegnaEventoPubblicato risposta = port.prelevaMessaggio(id, DAOMock.NOME_SOGGETTO_D, DAOMock.TIPO_SOGGETTO_SPC, DAOMock.CATEGORIA_EVENTI_ESTERNA_CONFERMATA_ATTIVA_9);
    ...
    public void testPrelievo28Clean() throws Exception {
        try {
            logger.info("TEST - 28");
            logger.info("Clean");
            Thread.currentThread().sleep(15000);
