...
@Entity
public class StatoMessaggioEsterno implements Serializable, IStatoMessaggio {

    private long id;
    private String stato;
    private Date dataAggiornamento;
    private String erroreProcessamento;
    private EventoPubblicatoEsterno eventoPubblicato;
    ...
    public EventoPubblicatoEsterno getEventoPubblicato() {
        return eventoPubblicato;
    }

    public void setEventoPubblicato(EventoPubblicatoEsterno eventoPubblicato) {
