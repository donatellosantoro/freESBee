...
public class StarterCodaNotificaEventoInterno extends RouteBuilder {

    private Log logger = LogFactory.getLog(this.getClass());

    public void configure() throws Exception {
        logger.info("Avvio della coda notifica interna");
        ...
        Queue destination = session.createQueue("notificainterna");
        ...
        consumer.setMessageListener(new CodaNotificaEventoInterno());
    }
}
