...
public class CodaNotificaEventoInterno implements MessageListener {
    ...
    public void onMessage(Message message) {
        ...
        try {
            ...
            logger.debug("Coda Notifica Interna -- Messaggio con ID: " + statoMessaggio.getEventoPubblicato().getId());
