...
public class Soggetto {
    ...
    public String toString() {
        return "Soggetto{" + "descrizione=" + descrizione + ", id=" + id + ", nome=" + nome + ", oldNomeForUpdate=" + oldNomeForUpdate + ", oldTipoForUpdate=" + oldTipoForUpdate + ", oraRegistrazione=" + oraRegistrazione + ", portaDominio=" + portaDominio + ", tipo=" + tipo + '}';
    }
