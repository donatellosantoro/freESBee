...
/**
 * <p>Java class for sottoscrizioneEsterna complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="sottoscrizioneEsterna">
 *   &lt;complexContent>
 ...
 *         &lt;element name="listaFiltroPublicatore" type="{http://ge.freesbee.unibas.it/}filtroPubblicatoreEsterno" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="scadenzaAttesa" type="{http://www.w3.org/2001/XMLSchema}dateTime" minOccurs="0"/>
...
@XmlType(name = "sottoscrizioneEsterna", propOrder = {
    "filtroContenuto",
    "filtroData",
    "id",
...
public class SottoscrizioneEsterna {

    protected FiltroContenuto filtroContenuto;
    protected FiltroData filtroData;
    protected long id;
    @XmlElement(required = true, nillable = true)
    protected List<FiltroPubblicatoreEsterno> listaFiltroPublicatore;
    protected XMLGregorianCalendar scadenzaAttesa;
     ...
     * {@link FiltroPubblicatoreEsterno }
     * 
     * 
     */
    public List<FiltroPubblicatoreEsterno> getListaFiltroPublicatore() {
        if (listaFiltroPublicatore == null) {
            listaFiltroPublicatore = new ArrayList<FiltroPubblicatoreEsterno>();
        }
        return this.listaFiltroPublicatore;
    }

    /**
     * Gets the value of the scadenzaAttesa property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public XMLGregorianCalendar getScadenzaAttesa() {
        return scadenzaAttesa;
    }

    /**
     * Sets the value of the scadenzaAttesa property.
     * 
     * @param value
     *     allowed object is
     *     {@link XMLGregorianCalendar }
     *     
     */
    public void setScadenzaAttesa(XMLGregorianCalendar value) {
        this.scadenzaAttesa = value;
    }
