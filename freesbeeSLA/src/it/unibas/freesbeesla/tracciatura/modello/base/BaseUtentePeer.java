    ...
    extends BasePeer
{
    ...
    {
        return getMapBuilder(UtenteMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
          ...
          if (Torque.isInit())
        {
            try
            {
                getMapBuilder(UtenteMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(UtenteMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "it.unibas.freesbeesla.tracciatura.modello.Utente";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Utente row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            Utente obj = (Utente) cls.newInstance();
            UtentePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        ...
        for (int i = 0; i < records.size(); i++)
        {
            Record row = (Record) records.get(i);
              results.add(UtentePeer.row2Object(row, 1,
                UtentePeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List doSelect(Utente obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Utente obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Utente obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Utente obj) throws TorqueException
    {
     ...
     * otherwise use the doUpdate(Utente) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Utente obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(Utente) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Utente obj, Connection con)
        throws TorqueException
    {
