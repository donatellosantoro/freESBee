...
@XmlType(propOrder = {
    ...
    "idInitiator",
    "idResponder",
    "resultGaranteeTermObjState"
})
public class ResponseServiceGuaranteeTermStateType {
    ...
    @XmlElement(name = "ResultGaranteeTermObjState", namespace = "http://sistemamonitoraggio.freesbee.unibas.it/", required = true) 
    protected List<ResultGaranteeTermObjState> resultGaranteeTermObjState;
     ...
     * 
     */
    public List<ResultGaranteeTermObjState> getResultGaranteeTermObjState() {
        if (resultGaranteeTermObjState == null) {
            setResultGaranteeTermObjState(new ArrayList<ResultGaranteeTermObjState>());
        }
        return this.resultGaranteeTermObjState;
    }

    public void setResultGaranteeTermObjState(List<ResultGaranteeTermObjState> resultGaranteeTermObjState) {
        this.resultGaranteeTermObjState = resultGaranteeTermObjState;
    }
