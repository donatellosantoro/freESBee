...
@XmlType(propOrder = {
    ...
    "guaranteeState",
    "observeInterval",
    "guaranteeTermsResult"
})
@XmlRootElement(name = "ResultGaranteeTermObjState")
public class ResultGaranteeTermObjStateSuper {
    ...
    @XmlElement(name = "GuaranteeTermsResult", namespace = "http://sistemamonitoraggio.freesbee.unibas.it/", required = true)
    protected GuaranteeTermsResult guaranteeTermsResult;
    ...
    /**
     * Gets the value of the guaranteeTermsResult property.
     *
     * @return
     *     possible object is
     *     {@link GuaranteeTermsResult }
     *
     */
    public GuaranteeTermsResult getGuaranteeTermsResult() {
        return guaranteeTermsResult;
    }

    /**
     * Sets the value of the guaranteeTermsResult property.
     *
     * @param value
     *     allowed object is
     *     {@link GuaranteeTermsResult }
     *
     */
    public void setGuaranteeTermsResult(GuaranteeTermsResult value) {
        this.guaranteeTermsResult = value;
    }
