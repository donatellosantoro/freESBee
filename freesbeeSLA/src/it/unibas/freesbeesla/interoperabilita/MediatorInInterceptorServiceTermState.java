...
public class MediatorInInterceptorServiceTermState extends AbstractPhaseInterceptor<SoapMessage> {

    private Log logger = LogFactory.getLog(this.getClass());

    public MediatorInInterceptorServiceTermState() {
...
//                String bodyMessaggio = AdapterNicaToFreesbee.trasformaMessaggioServiceTermState(stringaMessaggio);
...
//                    if (addressDesitnation.equals("/ws/monitoraggio/termstate/ServiceTermStateNica")) {
...
//
//            } else {
//                logger.debug("E' stao trovato il namespace: http://sistemamonitoraggio.freesbee.unibas.it/");
//
...
//                    String address = server.getEndpoint().getEndpointInfo().getAddress();
//                    String addressDesitnation = server.getDestination().getAddress().getAddress().getValue();
//                    if (addressDesitnation.equals("/ws/monitoraggio/termstate/ServiceTermStateFreESBee")) {
//                        logger.debug("************* TROVATO ******************");
//                        logger.debug("server: " + server.getEndpoint().getEndpointInfo().getName());
//                        logger.debug("address endpoint: " + address);
//                        logger.debug("address destination: " + addressDesitnation);
