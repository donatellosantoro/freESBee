...
public class XmlJDomUtil {
    ...
    public static void salvaXML(String nomeFile, Document document) throws Exception {
    ...
    public static Document caricaXML(String pathFile, boolean validate) throws Exception {
    ...
    public static Document caricaXML(String messaggio) throws Exception {
        if(messaggio==null){            
    ...
    public static Document caricaXML(InputStream isFile, boolean validate, InputStream isSource) throws Exception {
        try {
    ...
    public static Document transformToDocument(String fileXsl, Document documentXml) throws XSLTransformException, Exception {
    ...
    public static Document convert(org.w3c.dom.Document domDoc) throws Exception {
