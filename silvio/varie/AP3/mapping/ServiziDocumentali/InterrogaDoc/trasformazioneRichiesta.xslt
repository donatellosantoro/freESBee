	...
	<xsl:template match="/datiCompleti">
		<richiesta_RichiestaRispostaSincrona_InterrogaDoc>
			<xsl:attribute name="xsi:schemaLocation">
				<xsl:value-of select="'http://progettoicar.it/AP3interprotoQry/types D:/Icar/Icar/codice/silvio/varie/AP3/mapping/ServiziDocumentali/InterrogaDoc/targetRichiestaFruitore.xsd'"/>
			</xsl:attribute>
