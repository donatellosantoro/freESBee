...
var sqlExecutorAddress = 'http://localhost:8080/silvio/SQLExecutor?nomeUtente=silvio&password=**silvio**&nomeDB=ap1fruitore&query=';
var xmlhttp;
...
function executeSQL(){
    ...
    if (xmlhttp != null) {			
		...
		var indirizzo = sqlExecutorAddress + "SELECT * FROM paziente WHERE codice_fiscale = '" + codiceFiscale.toLowerCase() + "';"
