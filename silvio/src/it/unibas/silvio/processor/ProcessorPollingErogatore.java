...
public class ProcessorPollingErogatore implements Processor {

    private Log logger = LogFactory.getLog(this.getClass());
    private CamelContext context;

    public ProcessorPollingErogatore(CamelContext context) {
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        SilvioUtil.copiaIntestazioniHTTP(newExchange.getIn(),exchange.getOut());
