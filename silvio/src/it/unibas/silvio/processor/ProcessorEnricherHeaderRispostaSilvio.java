...
public class ProcessorEnricherHeaderRispostaSilvio implements Processor {

    private Log logger = LogFactory.getLog(this.getClass());

    public void process(Exchange exchange) throws Exception {
        Messaggio messaggio = (Messaggio) exchange.getProperty(CostantiSilvio.MESSAGGIO_RISPOSTA);
        ParametriMessaggioRicevuto parametriIstanza = messaggio.getParametriMessaggioRicevuto();
