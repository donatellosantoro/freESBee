...
public class RispostaAckErogatore extends RouteBuilder{
    
    private Log logger = LogFactory.getLog(this.getClass());

    @Override
    public void configure() throws Exception {
        this.from(CostantiCamel.RISPOSTA_ACK_EROGATORE)   
    ...
    private class ProcessorAck implements Processor{
        ...
        public void process(Exchange exchange) throws Exception {
            ...
            messaggioAck.setChannelErogatore(messaggio.getChannelErogatore());
