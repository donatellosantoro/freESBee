...
//    }
    ...
    public SoapMessage read(InputStream is, String contentType) throws Exception {
        if (marshaler.isSoap()) {
            return readSoapUsingStax(is,contentType);
        } else {
...
//                return readSoapUsingDom(is,contentType);
//            } else {
//                return readSoapUsingStax(is,contentType);
//        } else {
//            SoapMessage message = new SoapMessage();
...
//    }
    ...
    public SoapMessage read(MimeMessage mime) throws Exception {
        ...
        if (content instanceof MimeMultipart) {
            ...
            if (contentPart != null) {
                message = read(contentPart.getInputStream(),null);
            } else {
