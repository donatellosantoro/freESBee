...
public class SoapWriterFix {
    ...
    private void writeSimpleMessage(OutputStream out) throws Exception {
        ...
        XMLOutputFactory outputFactory = marshaler.getOutputFactory();
...
//        XMLStreamWriter writer = marshaler.getOutputFactory().createXMLStreamWriter(out);
        ...
        if (marshaler.isSoap()) {
            ...
            if (message.getFault() != null) {
                if (message.getFault().getDetails() != null) {
                    ...
                    XMLStreamHelperFix.copy(reader, writer);
    ...
    public void writeSoapEnvelope(XMLStreamWriter w) throws Exception {
        XMLStreamWriter2 writer = (XMLStreamWriter2) w;
        ...
        if (message.getHeaders() != null && message.getHeaders().size() > 0) {
            ...
            for (Iterator it = message.getHeaders().values().iterator(); it.hasNext();) {
                ...
                XMLStreamHelperFix.copy(new W3CDOMStreamReader(e), writer);
            }
        ...
        if (message.getFault() != null) {
            ...
            StreamSource streamSource = (StreamSource) message.getSource();
            ByteArrayOutputStream outString = new ByteArrayOutputStream();
            IOUtils.copy(streamSource.getInputStream(), outString);
            String body = outString.toString();
            // remove prolog <?xml ...>
...
//            XMLStreamHelper.writeTextQName(writer, code);
            XMLStreamHelperFix.writeStartElement(writer, SoapMarshaler.SOAP_11_FAULTCODE);
            XMLStreamHelperFix.writeTextQName(writer, code);
...
//        XMLStreamHelper.writeStartElement(writer, SoapMarshaler.SOAP_11_FAULTSTRING);
        XMLStreamHelperFix.writeStartElement(writer, SoapMarshaler.SOAP_11_FAULTSTRING);
        if (reason != null) {
...
//            XMLStreamHelper.writeStartElement(writer, SoapMarshaler.SOAP_11_FAULTACTOR);
            XMLStreamHelperFix.writeStartElement(writer, SoapMarshaler.SOAP_11_FAULTACTOR);
...
//            XMLStreamHelper.writeStartElement(writer, SoapMarshaler.SOAP_11_FAULTDETAIL);
            XMLStreamHelperFix.writeStartElement(writer, SoapMarshaler.SOAP_11_FAULTDETAIL);
...
//            XMLStreamHelper.writeTextQName(writer, code);
            XMLStreamHelperFix.writeStartElement(writer, SoapMarshaler.SOAP_12_FAULTCODE);
            XMLStreamHelperFix.writeStartElement(writer, SoapMarshaler.SOAP_12_FAULTVALUE);
            XMLStreamHelperFix.writeTextQName(writer, code);
            writer.writeEndElement();
...
//                XMLStreamHelper.writeTextQName(writer, subcode);
                XMLStreamHelperFix.writeStartElement(writer, SoapMarshaler.SOAP_12_FAULTSUBCODE);
                XMLStreamHelperFix.writeStartElement(writer, SoapMarshaler.SOAP_12_FAULTVALUE);
                XMLStreamHelperFix.writeTextQName(writer, subcode);
                writer.writeEndElement();
                writer.writeEndElement();
            }
            writer.writeEndElement();
...
//        XMLStreamHelper.writeStartElement(writer, SoapMarshaler.SOAP_12_FAULTTEXT);
        XMLStreamHelperFix.writeStartElement(writer, SoapMarshaler.SOAP_12_FAULTREASON);
        XMLStreamHelperFix.writeStartElement(writer, SoapMarshaler.SOAP_12_FAULTTEXT);
...
//            XMLStreamHelper.writeStartElement(writer, SoapMarshaler.SOAP_12_FAULTNODE);
            XMLStreamHelperFix.writeStartElement(writer, SoapMarshaler.SOAP_12_FAULTNODE);
            writer.writeCharacters(node.toString());
            writer.writeEndElement();
        }
...
//            XMLStreamHelper.writeStartElement(writer, SoapMarshaler.SOAP_12_FAULTROLE);
            XMLStreamHelperFix.writeStartElement(writer, SoapMarshaler.SOAP_12_FAULTROLE);
...
//            XMLStreamHelper.writeStartElement(writer, SoapMarshaler.SOAP_12_FAULTDETAIL);
            XMLStreamHelperFix.writeStartElement(writer, SoapMarshaler.SOAP_12_FAULTDETAIL);
            writeDetails(writer, details);
            writer.writeEndElement();
        }
