...
// Can be used to optionally enforce mutual client/server authentication.
// This is the most flexible implementation of a protocol socket factory. It
// allows for customization of most, if not all, aspects of the SSL authentication. 
...
public class AuthSSLProtocolSocketFactoryCustomized implements SecureProtocolSocketFactory {

    /** Log object for this class. */
//    private static final Log LOG = LogFactory.getLog(AuthSSLProtocolSocketFactoryCustomized.class);
    private static final Logger logger = LoggerFactory.getLogger(AuthSSLProtocolSocketFactoryCustomized.class.getName());

    private URL keystoreUrl = null;
//    private KeyStore keystoreUrl = null;
    private String keystorePassword = null;
    private URL truststoreUrl = null;
//    private KeyStore truststoreUrl = null;
     ...
     */
    public AuthSSLProtocolSocketFactoryCustomized(
        final URL keystoreUrl, final String keystorePassword, 
//        final KeyStore keystoreUrl, final String keystorePassword, 
        final URL truststoreUrl, final String truststorePassword)
//        final KeyStore truststoreUrl, final String truststorePassword)
    {
        super();
    ...
    { 
        ...
        for (int i = 0; i < trustmanagers.length; i++) {
            if (trustmanagers[i] instanceof X509TrustManager) {
                trustmanagers[i] = new AuthSSLX509TrustManagerCustomized(
...
//                KeyStore keystore = this.keystoreUrl;
...
//                KeyStore keystore = this.truststoreUrl;
                if (logger.isDebugEnabled()) {
                    Enumeration aliases = keystore.aliases();
                    while (aliases.hasMoreElements()) {
                        String alias = (String)aliases.nextElement();
