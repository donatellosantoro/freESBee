...
import it.unibas.icar.freesbee.modulocontrollo.imbustamento.WireTapTracciamentoImbustamento;
...
//    private static Log logger = LogFactory.getLog(ContentBasedRouterSbustamento.class);
    private static final org.slf4j.Logger logger = LoggerFactory.getLogger(ContentBasedRouterSbustamento.class.getName());
    @Inject
