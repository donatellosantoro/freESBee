...
/**
 * @version $Revision: 706005 $
 */
public class HttpBinding {

    // This should be a set of lower-case strings
    @Deprecated
    public static final Set<String> DEFAULT_HEADERS_TO_IGNORE = new HashSet<String>(Arrays.asList(HttpProducer.HTTP_RESPONSE_CODE.toLowerCase()));
    ...
    public void writeResponse(HttpExchange exchange, HttpServletResponse response) throws IOException {
        ...
        if (out != null) {
			...
			if (out.getHeader("Content-Type") != null) {
				String contentType = out.getHeader("Content-Type", String.class);
