...
//        Node nodoIDMessaggio = BustaUtil.cercaNodo(nodoTestRichiesta.getChildNodes(), "IDMessaggio");
//        Assert.assertNotNull(nodoIDMessaggio);
//        Node nodoFruitore = BustaUtil.cercaNodo(nodoTestRichiesta.getChildNodes(), "Fruitore");
//        Assert.assertNotNull(nodoFruitore);
//        String fruitore = nodoFruitore.getTextContent();
//        Assert.assertEquals(fruitore, "TEST_FRUITORE");
//        Node nodoErogatore = BustaUtil.cercaNodo(nodoTestRichiesta.getChildNodes(), "Erogatore");
//        String erogatore = nodoErogatore.getTextContent();
//        Assert.assertEquals(erogatore, "TEST_EROGATORE");
//        Node nodoServizio = BustaUtil.cercaNodo(nodoTestRichiesta.getChildNodes(), "Servizio");
