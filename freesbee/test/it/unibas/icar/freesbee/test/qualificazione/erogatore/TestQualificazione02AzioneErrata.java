...
//    protected Log logger = LogFactory.getLog(this.getClass());
    ...
    public void testQualificazione02AzioneErrata() {
        String richiesta = UtilTest.leggiMessaggio("/messaggi/2. AzioneErrataRichiesta.xml");
        ...
        Assert.assertEquals("AzioneErrata", azione);
        ...
        Assert.assertEquals("EGOV_IT_106", codiceEccezione);
        ...
        Assert.assertEquals("Azione", posizione);
