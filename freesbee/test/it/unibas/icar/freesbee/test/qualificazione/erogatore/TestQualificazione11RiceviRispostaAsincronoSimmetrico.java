...
public class TestQualificazione11RiceviRispostaAsincronoSimmetrico extends TestCase {

//    protected Log logger = LogFactory.getLog(this.getClass());
    private static final Logger logger = LoggerFactory.getLogger(TestQualificazione11RiceviRispostaAsincronoSimmetrico.class.getName());
    ...
    public void test1() {
        String richiesta = UtilTest.leggiMessaggio("/messaggi/11. riceviRispostaAsincronoSimmetricoRichiesta.xml");
        ...
        Assert.assertEquals("CNIPA", mittente);
        ...
        Assert.assertEquals("EGOV_IT_ServizioAsincronoSimmetrico", profiloCollaborazione);

        String collaborazione = UtilTest.trovaNodoString(expIntestazione + "/eGov_IT:Collaborazione", soapRisposta);
        Assert.assertEquals("CNIPA_CNIPAspcoopit_0000002_2007-11-07_16:29", collaborazione);

        String presaInCarico = UtilTest.trovaNodoString("/soapenv:Envelope/soapenv:Body/p891:risposta_NotificazioneRisposta_riceviRispostaTestAsincronoSimmetrico/p891:PresaInCarico", soapRisposta);
