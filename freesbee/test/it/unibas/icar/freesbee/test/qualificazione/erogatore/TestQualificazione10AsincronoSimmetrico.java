...
public class TestQualificazione10AsincronoSimmetrico extends TestCase {

//    protected Log logger = LogFactory.getLog(this.getClass());
    private static final Logger logger = LoggerFactory.getLogger(TestQualificazione10AsincronoSimmetrico.class.getName());
    ...
    public void test1() {
        String richiesta = UtilTest.leggiMessaggio("/messaggi/10. testAsincronoSimmetricoRichiesta.xml");
        ...
        Assert.assertEquals("testAsincronoSimmetrico", azione);

        String identificatore = UtilTest.trovaNodoString(expIntestazione + "/eGov_IT:Messaggio/eGov_IT:Identificatore", soapRisposta);
        Assert.assertTrue(identificatore.startsWith("PAGenerica_PAGenericaSPCoopIT"));
        ...
        String presaInCarico = UtilTest.trovaNodoString("/soapenv:Envelope/soapenv:Body/p891:risposta_RichiestaRispostaAsincrona_testAsincronoSimmetrico/p891:PresaInCarico", soapRisposta);
