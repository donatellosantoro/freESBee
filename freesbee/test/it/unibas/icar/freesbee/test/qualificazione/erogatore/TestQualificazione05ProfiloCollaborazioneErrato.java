...
public class TestQualificazione05ProfiloCollaborazioneErrato extends TestCase {

//    protected Log logger = LogFactory.getLog(this.getClass());
    private static final Logger logger = LoggerFactory.getLogger(TestQualificazione05ProfiloCollaborazioneErrato.class.getName());
    ...
    public void test1() {
        String richiesta = UtilTest.leggiMessaggio("/messaggi/5. ProfiloCollaborazioneErratoRichiesta.xml");
...
//        Assert.assertEquals("ProfiloErrato", profiloCollaborazione);
        ...
        Assert.assertEquals("EGOV_IT_103", codiceEccezione);
        ...
        Assert.assertEquals("ProfiloCollaborazione", posizione);
