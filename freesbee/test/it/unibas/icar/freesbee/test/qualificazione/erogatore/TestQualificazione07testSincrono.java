...
public class TestQualificazione07testSincrono extends TestCase {

//    protected Log logger = LogFactory.getLog(this.getClass());
    private static final Logger logger = LoggerFactory.getLogger(TestQualificazione07testSincrono.class.getName());
    ...
    public void test1() {
        String richiesta = UtilTest.leggiMessaggio("/messaggi/7. testSincronoRichiesta.xml");
