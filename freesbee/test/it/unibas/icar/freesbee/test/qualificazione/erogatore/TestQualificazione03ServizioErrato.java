...
//    protected Log logger = LogFactory.getLog(this.getClass());
    ...
    public void test1() {
        String richiesta = UtilTest.leggiMessaggio("/messaggi/3. ServizioErratoRichiesta.xml");
        ...
        Assert.assertEquals("ServizioErrato", servizio);
        ...
        Assert.assertEquals("EGOV_IT_105", codiceEccezione);
        ...
        Assert.assertEquals("Servizio", posizione);
