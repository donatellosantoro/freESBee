...
public class TestQualificazione09CheckAsincronoAsimettrico extends TestCase {

//    protected Log logger = LogFactory.getLog(this.getClass());
    private static final Logger logger = LoggerFactory.getLogger(TestQualificazione09CheckAsincronoAsimettrico.class.getName());
    ...
    public void test1() {
        String richiesta = UtilTest.leggiMessaggio("/messaggi/9. checkTestAsincronoAsimmetricoRichiesta.xml");
        ...
        Assert.assertEquals("checkTestAsincronoAsimmetrico", azione);
