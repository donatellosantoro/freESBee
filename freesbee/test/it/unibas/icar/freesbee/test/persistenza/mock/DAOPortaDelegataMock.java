...
public class DAOPortaDelegataMock implements IDAOPortaDelegata {
    ...
    public PortaDelegata findByNome(String nome) throws DAOException {
        ...
        soggettoFruitore.setTipo("SPC");
        soggettoFruitore.setNome("FRUITORE");
        
        Soggetto soggettoErogatore = new Soggetto();
        soggettoErogatore.setTipo("SPC");
        soggettoErogatore.setNome("EROGATORE");
        
        portaDelegata.setSoggettoFruitore(soggettoFruitore);
        
        Servizio servizio = new Servizio();
        servizio.setTipo("SPC");
        servizio.setNome("SERVIZIO");
