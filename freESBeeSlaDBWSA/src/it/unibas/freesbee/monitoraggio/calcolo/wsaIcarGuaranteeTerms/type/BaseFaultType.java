...
@XmlSeeAlso({
    ContinuingFaultType.class
})
public class BaseFaultType {

    @XmlAnyElement(lax = true)
    protected List<Object> any;
    @XmlElement(name = "Timestamp", namespace = "http://docs.oasis-open.org/wsrf/bf-2", required = true)
    protected XMLGregorianCalendar timestamp;
    @XmlElement(name = "Originator", namespace = "http://docs.oasis-open.org/wsrf/bf-2")
    ...
    @XmlElement(name = "FaultCause", namespace = "http://docs.oasis-open.org/wsrf/bf-2")
