...
public class MeanFunction extends AggregateFunction {
    
    protected MeanFunction(FunctionType funType, Window win, BasicMetric bm) {
        super("AVG");
    ...
    public double getResultOperationComplex(List<Double> listaRisultato) throws INF2Exception {
        if (listaRisultato.size() != 0 && listaRisultato != null) {
            ...
            return somma / listaRisultato.size();
        }
