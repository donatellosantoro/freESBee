...
public class AzioneSelezionaCartellaFileConfig extends AbstractAction {

    private Controllo controllo;

    public AzioneSelezionaCartellaFileConfig(Controllo controllo) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (percorso != null) {
            ...
            pp.setPercorsoFileConfig(percorso);
        }
    }
