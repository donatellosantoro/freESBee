...
public class SSOClient {
    ...
    public String sendSoapSamlRequest(String risorsa, Element portafoglioAsserzioni, String ssoSession, String stringaRichiesta) {
        ...
        try {
            ...
            logger.error("Inoltro la richiesta all'indirizzo " + risorsa);
