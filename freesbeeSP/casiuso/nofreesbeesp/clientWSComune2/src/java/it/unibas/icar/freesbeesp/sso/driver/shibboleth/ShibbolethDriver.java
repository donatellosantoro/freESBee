...
public class ShibbolethDriver implements ISSODriver {
    ...
    public SSOSessionResponse createSession(String username, String password, String risorsa, String idpEntityID) throws Exception {
        ...
        try {
            logger.debug("Nome Utente : " + username);
            logger.debug("Password : " + password);
            logger.debug("Risorsa PD : " + risorsa);
            logger.debug("Effettuo il login all'indirizzo : " + risorsa);
            ...
            logger.debug("Indirizzo login: " + indirizzoLogin);
            HtmlLogin loginStrategy = new HtmlLogin();
    ...
    private String contactDiscoveryService(String address, String idpEntityID) throws Exception {
        try {
            ...
            logger.debug("Indirizzo del Discovery Service " + indirizzoDS);
    ...
    public Map<String, String> verificaDiscoveryService(String risorsa) {
        ...
        try {
            ...
            logger.debug("Faccio una richiesta all'indirizzo " + risorsa);
    ...
    private SSOSessionResponse getShibSession(SAMLResponse samlResponse) throws Exception {
        try {
            ...
            logger.debug("Apro una session con " + samlResponse.getIndirizzo());
            HttpClient httpClient = new HttpClient();
            ...
            logger.debug("ShibSession - Session: " + shibSession.getSession());
            shibSession.setIndirizzo(indirizzo);
            logger.debug("ShibSession - Indirizzo: " + shibSession.getIndirizzo());
