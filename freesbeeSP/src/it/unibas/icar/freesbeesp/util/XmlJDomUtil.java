package it.unibas.icar.freesbeesp.util;
...
public class XmlJDomUtil {
    ...
    public static String transformToString(String messaggio, String fileXSLT) throws Exception {
        ...
        if(output==null){
            throw new XmlException("La trasformazione ha prodotto un risultato null");
        }
        return output.toString();
    }
    

    public static Document transformToDocument(String fileXsl, Document documentXml) throws XSLTransformException, XmlException {
    ...
    public static Document convert(org.w3c.dom.Document domDoc) throws XmlException {
        if(domDoc==null){
            throw new IllegalArgumentException("Impossibile convertire un documento null");
        }
        String stringaDocument = XMLUtils.toString(domDoc);
        return XmlJDomUtil.caricaXML(stringaDocument);
//        DOMBuilder builder = new DOMBuilder();
//        return builder.build(domDoc.getOwnerDocument());
    }
